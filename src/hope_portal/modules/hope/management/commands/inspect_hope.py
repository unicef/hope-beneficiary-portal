...
from hope_portal.utils.media import resource_path
...
class IRegexList(RegexList):
    def _compile(self, pattern: "str|re.Pattern", index: "int|None" = None) -> re.Pattern[AnyStr]:
        try:
            ...
            raise InvalidPattern(pattern) from None
...
class Command(BaseCommand):
    ...
    def handle_inspection(self, options):  # noqa
        ...
        with connection.cursor() as cursor:
            ...
            yield "from ._base import HopeModel, get_hope_storage"
            basemodel = "HopeModel"
    ...
    def get_field_type(self, connection: Any, table_name: str, row: list) -> tuple[str, dict[str, Any], list[str]]:
