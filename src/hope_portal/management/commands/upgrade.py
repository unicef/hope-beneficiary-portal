...
import hope_portal
from hope_portal.config import env
...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> None:  # noqa: C901
        from hope_portal.models import User  # noqa: PLC0415
        ...
        try:
            ...
            echo(f"Running upgrade of version {hope_portal.VERSION}", style_func=self.style.WARNING)
